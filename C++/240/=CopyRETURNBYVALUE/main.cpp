...
//SAME AS THE OTHER FILE, BUT THE ONLY THING I'M CHANGING IS THAT THE OPERATOR= WILL NOW RETURN BY VALUE, SO IT WILL MAKE IT END UP USING THE COPY CONSTRUCTOR. SO I'LL ALSO UPDATE THE COMMENTS & SUMMARY TO BE ACCURATE.
...
//***************************************************//
//CHANGE---->   DOES NOT RETURN BY REFERENCE ANYMORE //
//***************************************************//
...
int main()
{
	...
	Derived f, g;
	f = g; 		//OPERATOR=, COPY CONSTRUCTOR
	f = f;		//OPERATOR=, COPY CONSTRUCTOR
	*/
}
